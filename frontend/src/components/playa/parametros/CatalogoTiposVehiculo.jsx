...
const CatalogoTiposVehiculo = () => {
    ...
    const fetchRows = async () => {
        try {
            ...
            const res = await axios.get(`${API_URL}/playa/catalogo/tipos-vehiculo?todo=true`, {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editing) {
                await axios.put(`${API_URL}/playa/catalogo/tipos-vehiculo/${editing.id_tipo}`, formData, { headers });
            } else {
                await axios.post(`${API_URL}/playa/catalogo/tipos-vehiculo`, formData, { headers });
            }
            closeModal();
            fetchRows();
        } catch (error) {
    ...
    const handleDelete = async (row) => {
        ...
        try {
            const token = sessionStorage.getItem('token');
            await axios.delete(`${API_URL}/playa/catalogo/tipos-vehiculo/${row.id_tipo}`, {
                headers: { Authorization: `Bearer ${token}` }
            });
            fetchRows();
        } catch (error) {
    ...
    return (
        <div className="tipos-gastos-container">
            <div className="header-actions">
                <h2>Tipos de vehículos (catálogo general)</h2>
            ...
            {showModal && (
                <div className="modal-overlay">
                    <div className="modal-content">
                        <h3>{editing ? 'Editar tipo' : 'Nuevo tipo'}</h3>
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-check">
                                ...
                                />
                                <label htmlFor="chkActivoTipo">Activo</label>
                            </div>
...
export default CatalogoTiposVehiculo;
