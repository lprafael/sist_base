...
CREATE INDEX IF NOT EXISTS idx_noticias_torneo_id ON cancha.noticias_torneo(torneo_id);
CREATE INDEX IF NOT EXISTS idx_noticias_fecha ON cancha.noticias_torneo(fecha_publicacion DESC);
"""

migration_down = """
DROP INDEX IF EXISTS idx_noticias_fecha;
DROP INDEX IF EXISTS idx_noticias_torneo_id;
DROP TABLE IF EXISTS cancha.noticias_torneo;
"""
