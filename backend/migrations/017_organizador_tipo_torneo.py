...
migration_up = """
ALTER TABLE cancha.organizadores ADD COLUMN IF NOT EXISTS tipo_torneo VARCHAR(50) DEFAULT 'futbol';
"""

migration_down = """
ALTER TABLE cancha.organizadores DROP COLUMN IF NOT EXISTS tipo_torneo;
"""
...
if __name__ == "__main__":
    ...
    async def run():
        print(f"Ejecutando migracion 017: Organizador Tipo Torneo ({direction.upper()})...")
