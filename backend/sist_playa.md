...
-- ============================================
CREATE TABLE documentos_inforconf (
...
-- ============================================
CREATE TABLE tipos_gastos_productos (
...
-- ============================================
CREATE TABLE tipos_gastos_empresa (
...
-- ============================================
CREATE TABLE config_calificaciones (
...
CREATE INDEX idx_productos_chasis ON productos(chasis);
CREATE INDEX idx_productos_estado ON productos(estado_disponibilidad);
CREATE INDEX idx_ventas_cliente ON ventas(id_cliente);
CREATE INDEX idx_ventas_producto ON ventas(id_producto);
CREATE INDEX idx_ventas_fecha ON ventas(fecha_venta);
CREATE INDEX idx_pagares_venta ON pagares(id_venta);
CREATE INDEX idx_pagares_vencimiento ON pagares(fecha_vencimiento);
CREATE INDEX idx_pagares_estado ON pagares(estado);
CREATE INDEX idx_pagos_pagare ON pagos(id_pagare);
CREATE INDEX idx_pagos_fecha ON pagos(fecha_pago);
CREATE INDEX idx_gastos_productos ON gastos_productos(id_producto);
CREATE INDEX idx_gastos_empresa_fecha ON gastos_empresa(fecha_gasto);

-- ============================================
-- DATOS INICIALES: CONFIGURACIÓN DE CALIFICACIONES
-- ============================================
INSERT INTO config_calificaciones (nombre, dias_atraso_desde, dias_atraso_hasta, calificacion, descripcion) VALUES
...
-- ============================================
-- DATOS INICIALES: TIPOS DE GASTOS DE PRODUCTOS
-- ============================================
INSERT INTO tipos_gastos_productos (nombre, descripcion) VALUES
...
-- ============================================
-- DATOS INICIALES: TIPOS DE GASTOS DE EMPRESA
-- ============================================
INSERT INTO tipos_gastos_empresa (nombre, descripcion, es_fijo) VALUES
...
-- ============================================
-- DATOS INICIALES: CATEGORÍAS DE VEHÍCULOS
-- ============================================
...
-- Vista: Costo total por producto
CREATE VIEW v_costo_total_productos AS
SELECT 
    p.id_producto,
    p.codigo_interno,
    p.marca,
...
-- Vista: Estado de pagos por venta
CREATE VIEW v_estado_pagos_ventas AS
SELECT 
    v.id_venta,
    v.numero_venta,
...
CREATE VIEW v_proximos_vencimientos AS
SELECT 
    pg.id_pagare,
    pg.numero_pagare,
    v.numero_venta,
...
-- ============================================
-- FUNCIÓN: Calcular días de atraso
-- ============================================
...
-- ============================================
-- FUNCIÓN: Obtener calificación según días de atraso
-- ============================================
CREATE OR REPLACE FUNCTION obtener_calificacion(dias_atraso INTEGER)
RETURNS VARCHAR AS $$
DECLARE
...
BEGIN
    ...
    WHERE dias_atraso BETWEEN dias_atraso_desde AND COALESCE(dias_atraso_hasta, 999999)
    AND activo = TRUE
    LIMIT 1;
...
BEGIN
    ...
    nueva_calificacion := obtener_calificacion(NEW.dias_atraso);
    
    -- Si cambió la calificación, actualizar y registrar
    IF nueva_calificacion != calificacion_anterior THEN
        UPDATE clientes 
        SET calificacion_actual = nueva_calificacion
...
-- ============================================
COMMENT ON TABLE clientes IS 'Almacena información de los clientes';
COMMENT ON TABLE garantes IS 'Almacena información de los garantes de los clientes';
COMMENT ON TABLE productos IS 'Almacena información de los vehículos en venta';
COMMENT ON TABLE ventas IS 'Registra las ventas realizadas';
COMMENT ON TABLE pagares IS 'Registra los pagarés de las ventas financiadas';
COMMENT ON TABLE pagos IS 'Registra los pagos realizados por los clientes';
COMMENT ON TABLE gastos_productos IS 'Registra todos los gastos asociados a cada vehículo';
COMMENT ON TABLE gastos_empresa IS 'Registra los gastos operativos de la empresa';
