...
async def main():
    async with engine.connect() as conn:
        ...
        print(f"Cargando 30 atletas en Torneo: '{target_torneo_nombre}' (ID: {target_torneo_id})...")
        ...
        # 3. Limpiar atletas previos para este torneo
        await conn.execute(text("""
        ...
        print("\n=======================================================")
        print(f"EXITO TOTAL: Se cargaron los {inserted_count} atletas de prueba en '{target_torneo_nombre}'")
        print(f"Torneo ID: {target_torneo_id}")
        print("=======================================================")
